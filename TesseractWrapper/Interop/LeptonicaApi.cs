...
{		
	...
	/// </remarks>
    public static class LeptonicaApi
    {
    	#region PixA
        ...
        public static extern int pixSauvolaBinarizeTiled(HandleRef pix, int whsize, float factor, int nx, int ny, out IntPtr ppixth, out IntPtr ppixd);
        ...
        //Was added at 1.73 -> 1.74
        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetRangeValues")]
        public static extern int pixcmapGetRangeValues(HandleRef cmap, int select, out int minVal, out int maxVal, out int minIndex, out int maxIndex);
