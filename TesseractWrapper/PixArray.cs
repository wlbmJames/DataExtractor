...
namespace TesseractWrapper
{
	...
	public class PixArray : DisposableBase, IEnumerable<Pix>
	{
        ...
        //{
        //    var pixaHandle = Interop.LeptonicaApi.pixaCreate(n);
        //    if (pixaHandle == IntPtr.Zero)
        //    {
        ...
        //    int result = Interop.LeptonicaApi.pixaAddPix(_handle, pix.Handle, copyflag);
        //    if (result == 0)
        //    {
        //        _count = Interop.LeptonicaApi.pixaGetCount(_handle);
        //    }
        ...
        //    VerifyNotDisposed();
        //    if(Interop.LeptonicaApi.pixaRemovePix(_handle, index) == 0)
        //    {
        //        _count = Interop.LeptonicaApi.pixaGetCount(_handle);
        //    }
        //}
        ...
        //{
        //    VerifyNotDisposed();
        //    if (Interop.LeptonicaApi.pixaClear(_handle) == 0)
        //    {
        //        _count = Interop.LeptonicaApi.pixaGetCount(_handle);
        //    }
        //}
