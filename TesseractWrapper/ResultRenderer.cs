...
namespace TesseractWrapper
{
    ...
    public abstract class ResultRenderer : DisposableBase, IResultRenderer
    {
            ...
            foreach (RenderedFormat format in outputFormats)
            {
                switch (format)
                {
                    case RenderedFormat.TEXT:
                        ...
                        {
                            Interop.TessApi.ResultRendererInsert(((ResultRenderer)renderer).Handle, new TextResultRenderer(outputbase).Handle);
                        }
                        break;
                    case RenderedFormat.HOCR:
                        ...
                        {
                            Interop.TessApi.ResultRendererInsert(((ResultRenderer)renderer).Handle, new HOcrResultRenderer(outputbase).Handle);
                        }
                        break;
                    case RenderedFormat.PDF:
                        //dataPath = Interop.TessApi.BaseAPIGetDatapath(handle);
                        if (renderer == null)
                        {
                        ...
                        {
                            Interop.TessApi.ResultRendererInsert(((ResultRenderer)renderer).Handle, new PdfResultRenderer(outputbase, dataPath).Handle);
                        }
                        break;
                    case RenderedFormat.BOX:
                        ...
                        {
                            Interop.TessApi.ResultRendererInsert(((ResultRenderer)renderer).Handle, new BoxResultRenderer(outputbase).Handle);
                        }
                        break;
                    case RenderedFormat.UNLV:
                        ...
                        {
                            Interop.TessApi.ResultRendererInsert(((ResultRenderer)renderer).Handle, new UnlvResultRenderer(outputbase).Handle);
                        }
                        break;
                }
            }
        ...
        {
            //IntPtr fontDir = Marshal.StringToHGlobalAnsi(fontDirectory);
        ...
        public bool AddPage(Page page)
        {
            if (_currentDocumentHandle == null)
                _currentDocumentHandle = BeginDocument("");
    ...
    public sealed class PdfResultRenderer : ResultRenderer
    {
        ...
        public PdfResultRenderer(string outputFilename, string fontDirectory)
        {
            ...
            int textoverlay = 0;
            var rendererHandle = Interop.TessApi.PDFRendererCreateTextonly(outputFilename, fontDirectoryHandle, textoverlay);
